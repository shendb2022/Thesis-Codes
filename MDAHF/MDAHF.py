...
import numpy as np
from utils.functions import checkFile
...
import math
from utils.functions import generateRandomList
import cv2
import os
...
class deepNet(object):
    '''
    the implementation of ADMM-HFNet(MDAHF)
    ...
    def __init__(self, num=0):
        ...
        self.train_batch_size = 3  # 64
        self.valid_batch_size = 3  # 16
        # 32
        self.data_num = num
